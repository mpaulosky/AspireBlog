...
public class FakeBlogPostDtoTests
{
	...
	{
		// Act
		BlogPostDto? blogPostDto = FakeBlogPostDto.GetNewBlogPostDto();
		BlogPostDto? blogPostDto2 = FakeBlogPostDto.GetNewBlogPostDto();
	...
	public void GetNewBlogPostDto_Should_Return_BlogPostDto_With_KeptId_True_When_KeepId_True()
	{
		...
		BlogPostDto? blogPostDto2 = FakeBlogPostDto.GetNewBlogPostDto(true);
	...
	public void GetNewBlogPostDto_Should_Return_BlogPostDto_Without_Id_When_When_KeepId_Is_False_And_UseSeed_Is_True()
	{
		...
		// Act
		BlogPostDto? blogPostDto = FakeBlogPostDto.GetNewBlogPostDto(false, true);
		BlogPostDto? blogPostDto2 = FakeBlogPostDto.GetNewBlogPostDto(false, true);
	...
	{
		// Act
		BlogPostDto? blogPostDto = FakeBlogPostDto.GetNewBlogPostDto(true, true);
		BlogPostDto? blogPostDto2 = FakeBlogPostDto.GetNewBlogPostDto(true, true);
		...
		bool useSeed)
	{
		...
		// Act
		List<BlogPostDto>? categories = FakeBlogPostDto.GetBlogPostDtos(countRequested, useSeed);
	...
	{
		// Act
		BlogPostDto? blogPostDto = FakeBlogPostDto.FakeData(false);
	...
	{
		// Act
		BlogPostDto? blogPostDto1 = FakeBlogPostDto.FakeData(true);
		BlogPostDto? blogPostDto2 = FakeBlogPostDto.FakeData(true);
